    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Lulu Kitchen משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ab9d7a07-60f5-4b7b-8b7f-864ed1efd87b',
                    name: data.name || '',
                    email: data.email || '',
